...
/**
 * Check if preflight cache exists with matching version and passed: true.
 * No TTL -- cache is valid until --force or version mismatch.
 * Returns true when valid cache exists, null otherwise.
 */
